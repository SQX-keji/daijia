<template>
	<view>
		<view class="head">
			<view class="flex align-center justify-between padding-lr">
				<view class="flex align-center justify-center" @tap="binduser()">
					...
					<view>
						...
						<view class="text-sm margin-left-sm" style="font-weight: 200;" v-if="mobile">
							信用分:{{creditScore}}分</view>
					</view>
				</view>
				<image v-if="mobile" @click="goNav('/my/setting/message')" src="../../static/image/my/msg.png"
			...
			<view class="tabbox margin-top" v-if="xcxSelect!='否'">
